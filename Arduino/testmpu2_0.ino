...
void main_fun(); //just random stuff
...
void loop() {
  ...
  switch(state_main)
  {
    case 0:
        ...
        if (button == 1) { state_main = 1; }
        break;

    case 1:
         if (button == 0) { state_main = 2; }
         break;
    ...
    case 3:
        if (button == 0) { state_main = 4; }
        break;

    case 4:
        main_fun();
        if (button == 1) { state_main = 5; }
        break;

    case 5:
        if (button == 0) { state_main = 0; }
        break;
...
void setServos(int serv, int value) {
  ...
  int const_offs[12] = { 10, 45, 23, 15, 0, -23, -11, -12, -66, 55, 50, -20 };
...
void main_fun() {
    ...
    updateVal(&leg_currs[6], fun_curr1, K1);
    updateVal(&leg_currs[7], fun_curr1, K1);
    updateVal(&leg_currs[10],fun_curr2, K2);
    updateVal(&leg_currs[11],fun_curr2, K2);

    updateVal(&leg_currs[0],fun_curr5, K3);
    updateVal(&leg_currs[3],fun_curr5, K3);

    updateVal(&leg_currs[4], fun_curr3, K1);
    updateVal(&leg_currs[5], fun_curr3, K1);
    updateVal(&leg_currs[8],fun_curr4, K2);
    updateVal(&leg_currs[9],fun_curr4, K2);

    updateVal(&leg_currs[1],-fun_curr5, K3);
    updateVal(&leg_currs[2],-fun_curr5, K3);
